...
.cta{margin-top:25px}
button{background:white;color:#2563eb;border:none;padding:14px 28px;border-radius:8px;font-size:16px;font-weight:600;cursor:pointer;transition:0.3s}
button:hover{background:#e0e7ff}
section{max-width:1100px;margin:auto;padding:70px 20px}
h2{font-size:32px;margin-bottom:25px;color:#2563eb}
...
.contact{background:#2563eb;color:white;border-radius:18px;padding:50px;text-align:center}
